    ...
    return (
        <section id="Home" ref={scrollTab} className='home'>
            <div className="content">
                ...
                <a href="https://drive.google.com/file/d/1Fzwy8IAEy-YjiF6RXJ8lybKsdksCkBne/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='animation active '>
                    Download My CV
                </a>
            </div>
