    ...
    return (
        <section id="Home" ref={scrollTab} className='home'>
            <div className="content">
                ...
                <a href="https://drive.google.com/file/d/1ggW1lSNjP9ZBovuallZxjf1395QDqhk3/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='animation active '>
                    Download My CV
                </a>
            </div>
