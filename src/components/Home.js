    ...
    return (
        <section id="Home" ref={scrollTab} className='home'>
            <div className="content">
                ...
                <a href="https://drive.google.com/file/d/1yMYqdhsc95HN-5I8zyS6Bzuike1GLjg3/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='animation active '>
                    Download My CV
                </a>
            </div>
